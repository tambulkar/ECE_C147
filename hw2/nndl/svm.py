...
class SVM(object):
    ...
    def loss(self, X, y):
        ...
        for i in np.arange(num_train):
            ...
            for j in np.arange(num_classes):
                if j != y[i]:
                    loss += max(
                        0, 1 + np.dot(self.W[j], X[i]) - np.dot(self.W[y[i]], X[i])
                    )
    ...
    def loss_and_grad(self, X, y):
        ...
        for i in np.arange(num_train):
            ...
            # ================================================================ #
            for j in np.arange(num_classes):
                z_j = 1 + np.dot(self.W[j], X[i]) - np.dot(self.W[y[i]], X[i])
                if j != y[i]:
                    loss += max(0, z_j)
                    grad[j] += X[i] if z_j > 0 else 0
                    grad[y[i]] -= X[i] if z_j > 0 else 0
    ...
    def fast_loss_and_grad(self, X, y):
        ...
        Z = np.maximum(0, 1 + W_x - W_x[y, np.arange(N)])
        loss = np.sum(np.sum(Z, axis=0) - 1) / N
        # ================================================================ #
        # END YOUR CODE HERE
        # ================================================================ #
        ...
        # ================================================================ #
        Z = (Z > 0).astype(int)
        Z[y, np.arange(N)] = -(np.sum(Z, axis=0) - 1)
        grad = np.dot(Z, X) / N
        # ================================================================ #
        # END YOUR CODE HERE
        # ================================================================ #
